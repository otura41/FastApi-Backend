...
# print("DB URL:", f"postgresql://{os.environ['DATABASE_USER']}:{password}@{os.environ['DATABASE_HOST']}:{os.environ['DATABASE_PORT']}/{os.environ['DATABASE_NAME']}")

# config = context.config

# config.set_main_option(
#     "sqlalchemy.url",
#     f"postgresql://{os.environ['DATABASE_USER']}:{password}@{os.environ['DATABASE_HOST']}:{os.environ['DATABASE_PORT']}/{os.environ['DATABASE_NAME']}"
# )
...
# Usa DATABASE_URL si existe, si no, arma la URL con las otras variables
